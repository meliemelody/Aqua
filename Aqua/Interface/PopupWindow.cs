...
namespace Aqua.Interface
{
    public class PopupWindow : Window
    {
        const int new_Width = 25,
            new_Height = 5;
        static readonly int _x = Console.WindowWidth / 2 - new_Width / 2,
            _y = Console.WindowHeight / 2 - new_Height / 2;
        ...
        public PopupWindow(string title)
            : base(title, new_Width, new_Height, _x, _y)
        {
            // The width and height of the button.
            int buttonWidth = 5,
                buttonHeight = 3;

            // Create the button and add it to the window's inputs list.
